...
import { formatKg } from "../utils/helpers.js";
import { recommendationCard } from "./ui.js";
    ...
    <div class="grid two-col">
      ...
      <div class="card">
        ...
        ${state.started.length ? state.started.map((id) => {
          ...
          return rec ? `<div class="recommendation-row"><strong>${rec.title}</strong><span class="muted">Expected annual reduction: ${formatKg(rec.impact)}</span><div class="bar"><span style="width:42%;background:var(--sage)"></span></div></div>` : "";
